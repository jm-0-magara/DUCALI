// src/app/dashboard/artisan/components/EnhancedArtisanSettings.tsx
...
interface EnhancedArtisanSettingsProps {
  user: User;
}

export function EnhancedArtisanSettings({ user }: EnhancedArtisanSettingsProps) {
